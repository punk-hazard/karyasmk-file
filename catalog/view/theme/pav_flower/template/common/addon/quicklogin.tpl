			...
			<div class="col-lg-6 col-sm-6 col-xs-12">
				<div class="inner no-margin">
					...
					<div class="content">
						...
						<a href="<?php // echo $register; ?>" class="button btn btn-primary btn-outline"><?php echo $this->language->get('button_continue'); ?>  </a>
					</div>
				</div>
			</div>
			<div class="col-lg-6 col-sm-6 col-xs-12">
				<div class="inner underline no-margin">
					...
					<form action="<?php echo  $this->url->link('account/login', '', 'SSL'); ?>" method="post" enctype="multipart/form-data" role="form">									
						<div class="content">					  
							...
							<input type="submit" value="<?php echo $this->language->get('button_login'); ?>" class="button btn btn-primary btn-outline" />
