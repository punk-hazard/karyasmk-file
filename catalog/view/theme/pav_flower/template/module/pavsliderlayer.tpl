...
<?php } ?>
			<div class="bannercontainer hidden-xs banner-<?php echo trim($class);?>" style="padding: <?php echo $sliderParams['padding'];?>;margin: <?php echo $sliderParams['margin'];?>;">
					<div id="sliderlayer<?php echo $randID; ?>" class="rev_slider <?php echo trim($class);?>banner radius-1x" style="width:100%;height:<?php echo $sliderParams['height'];?>px; " >
