                    ...
                    <div class="input-group">
                        <form action="#" method="post">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="action" value="0" />
                                <div class="input-group-btn">
                                    <button type="submit" class="btn btn-primary btn-lg radius-right-5x" name="submitNewsletter" >Subscribe</button>
                                </div>
...
<?php }elseif($newsletter_style == 'newsletter-v6'){?>
    <div class="newsletter-v6 bg-primary light-style space-50">
        <div class="row">
            <div class="col-md-3 col-md-offset-1 text-right xs-space-30">
                 <?php if( $show_title ) { ?><h4 class="newsletter-label"><?php echo $heading_title;?></h4><?php }?>
                <?php if($information){?>
                    <p><?php echo $information;?></p>
                <?php }?>
            ...
            <div class="col-md-6">
                <form action="#" method="post">
                    <div class="input-group">
                        ...
                        <input type="hidden" name="action" value="0" />
                        <div class="input-group-btn">
                            <button type="submit" class="btn btn-lg btn-primary radius-right-5x" name="submitNewsletter" >Subscribe</button>
                        </div>
                    </div>
                </form>
            </div>
