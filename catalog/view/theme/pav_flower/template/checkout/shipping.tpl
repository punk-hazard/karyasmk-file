		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('.breadcrumbs').after('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
			...
			if (json['shipping_method']) {
				...
				html += '        <button type="button" class="btn btn-primary" data-dismiss="modal"><?php echo $button_cancel; ?></button>';
