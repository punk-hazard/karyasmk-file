...
<div class="img-banner container space-padding-tb-20 text-center">
	<img class="img-responsive" src="image/catalog/demo/banners/banner_deal.jpg" alt="banner deal">
</div>
...
<div class="container-inside row">
	...
	<div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>">
		<div id="content" class="space-padding-0">
			<div class="deals">
				<div class="panel-default space-30">
				...
				<div class="product-filter products-filter-panel clearfix">
