...
class PtsWidgetBanner_paralax extends PtsWidgetPageBuilder {
		...
		public static function getWidgetInfo(){
			return array('label' =>  ('Banner Paralax'), 'explain' => 'Banner paralax', 'group' => 'image'  );
		}
			...
			$helper = $this->getFormHelper();
		 	...
		 	$this->fields_form[1]['form'] = array(
	            ...
	            'input' => array(
	                ...
	                array(
	                    'type' => 'select',
	                    'label' => $this->l( 'mage parallax' ),
	                    'name' => 'image_parallax',
	                    'desc'  => 'Select image parallax',
	                    'options' => array(  'query' => array(
	                        array('id' => 'default', 'name' => $this->l('Image default')),
	                        array('id' => 'v1', 'name' => $this->l('Image paralax v1')),
	                    ),
	                    'id' => 'id',
	                    'name' => 'name' ),
	                    'default' => "",
