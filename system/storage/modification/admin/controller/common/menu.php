...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['jne_setting'] = $this->url->link('jne/setting', 'token=' . $this->session->data['token'], true);   
		}
		...
		$data['text_openbay_order_import'] = $this->language->get('text_openbay_order_import');
		  ...
		  $data['text_confirm_bayar'] = $this->language->get('text_confirm_bayar');
			...
			$data['confirm_setting'] = $this->url->link('konfirmasi/setting', 'token=' . $this->session->data['token'], 'SSL');
