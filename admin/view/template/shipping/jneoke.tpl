    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="jneoke_total"><span data-toggle="tooltip" title="<?php echo $help_total; ?>"><?php echo $entry_total; ?></span></label>        
				<div class="col-sm-10">            
            <input type="text" name="jneoke_total" id="jneoke_total" value="<?php echo $jneoke_total; ?>" class="form-control" />
        		</div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label" for="jneoke_status"><?php echo $entry_status; ?></span></label>        
				<div class="col-sm-10">            
           <select name="jneoke_status" id="jneoke_status" class="form-control">
       ...
       <div class="form-group">
            <label class="col-sm-2 control-label" for="jneoke_tax_class_id"><?php echo $entry_tax_class; ?></label>        
				<div class="col-sm-10">            
 <select name="jneoke_tax_class_id" id="jneoke_tax_class_id" class="form-control">
                  <option value="0"><?php echo $text_none; ?></option>
                  <?php foreach ($tax_classes as $tax_class) { ?>
                  <?php if ($tax_class['tax_class_id'] == $jneoke_tax_class_id) { ?>
         ...
         <div class="form-group">
            <label class="col-sm-2 control-label" for="jneoke_geo_zone_id"><?php echo $entry_geo_zone; ?></label>        
				<div class="col-sm-10">            
<select name="jneoke_geo_zone_id" id="jneoke_geo_zone_id" class="form-control">
                  <option value="0"><?php echo $text_all_zones; ?></option>
                  <?php foreach ($geo_zones as $geo_zone) { ?>
                  <?php if ($geo_zone['geo_zone_id'] == $jneoke_geo_zone_id) { ?>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="jneoke_sort_order"><?php echo $entry_sort_order; ?></label>        
				<div class="col-sm-10">            
            <input type="text" name="jneoke_sort_order" id="jneoke_sort_order" class="form-control"  value="<?php echo $jneoke_sort_order; ?>" />
        		</div>
        </div>
        <div class="form-group">
...
function getProducts() {
	...
	$.ajax({
		url: 'index.php?route=shipping/jneoke/category&token=<?php echo $token; ?>&category_id=' + $('#category').val(),
		dataType: 'json',
...
function getFiltered() {
	...
	$.ajax({
		url: 'index.php?route=shipping/jneoke/filtered&token=<?php echo $token; ?>',
		type: 'POST',
		dataType: 'json',
