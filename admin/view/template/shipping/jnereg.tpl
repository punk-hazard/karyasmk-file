    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="jnereg_total"><span data-toggle="tooltip" title="<?php echo $help_total; ?>"><?php echo $entry_total; ?></span></label>        
				<div class="col-sm-10">            
            <input type="text" name="jnereg_total" id="jnereg_total" value="<?php echo $jnereg_total; ?>" class="form-control" />
        		</div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label" for="jnereg_status"><?php echo $entry_status; ?></span></label>        
				<div class="col-sm-10">            
           <select name="jnereg_status" id="jnereg_status" class="form-control">
       ...
       <div class="form-group">
            <label class="col-sm-2 control-label" for="jnereg_tax_class_id"><?php echo $entry_tax_class; ?></label>        
				<div class="col-sm-10">            
 <select name="jnereg_tax_class_id" id="jnereg_tax_class_id" class="form-control">
         ...
         <div class="form-group">
            <label class="col-sm-2 control-label" for="jnereg_geo_zone_id"><?php echo $entry_geo_zone; ?></label>        
				<div class="col-sm-10">            
<select name="jnereg_geo_zone_id" id="jnereg_geo_zone_id" class="form-control">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="jnereg_sort_order"><?php echo $entry_sort_order; ?></label>        
				<div class="col-sm-10">            
            <input type="text" name="jnereg_sort_order" id="jnereg_sort_order" class="form-control"  value="<?php echo $jnereg_sort_order; ?>" />
        		</div>
        </div>
        <div class="form-group">
...
function getProducts() {
	...
	$.ajax({
		url: 'index.php?route=shipping/jnereg/category&token=<?php echo $token; ?>&category_id=' + $('#category').val(),
		dataType: 'json',
...
function getFiltered() {
	...
	$.ajax({
		url: 'index.php?route=shipping/jnereg/filtered&token=<?php echo $token; ?>',
		type: 'POST',
		dataType: 'json',
